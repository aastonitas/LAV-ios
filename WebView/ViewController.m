...
//
/************************************************************************************************************************/
NSString *host = @"lavisionweb.com";  // Domain host without http:// or www. (e.g. "google.com")
NSString *webviewurl = @"https://lavisionweb.com";  //Your URL including http:// and www.
...
NSString *deletechache = @"true";  //Set to "true" to delete the chache while starting the app
...
NSString *firstrunmessagetitle = @"Bienvenido!";  //Title label of the "First run" alert box
NSString *firstrunmessage = @"Gracias por descargar esta aplicación!"; //Text label of the "First run" alert box
NSString *offlinetitle = @"Error de conexión";  //Title label of the "Offline" alert box
NSString *offlinemsg = @"Por favor verifique su conexión.";  //Text of the "Offline" alert box
NSString *screen1 = @"¿Conexión inactiva?";  //Text label 1 of the "Offline" screen
NSString *screen2 = @"WiFi y datos móviles son compatibles.";  //Text label 2 of the "Offline" screen
NSString *buttontext = @"Inténtalo de nuevo";  //Text label of the "Try again" button
NSString *ratemyapptitle = @"¿Te gusta nuestra aplicación?";  //Title label of the "Rate my app" dialog box
NSString *ratemyapptext = @"Si es así, tómese un momento para calificar mi aplicación.";  //Text label of the "Rate my app" dialog
NSString *ratemyappyes = @"Calificar"; //Text label of the "Yes" button on "Rate my app" dialog box
NSString *ratemyappno = @"No";  //Text label of the "No" button on "Rate my app" dialog box
NSString *ratemyappurl = @"https://apps.apple.com/us/app/la-vision-newspaper/id1283246885?l=es&ls=1";  //Your App Store URL for the "Rate my app" dialog (there is a "View in App Store" link in iTunes Connect)
NSString *becomefacebookfriendstitle = @"Manténganse al tanto";  //Title label of the "Follow on Facebook" dialog
NSString *becomefacebookfriendstext = @"¿Nos sigues en Facebook?";  //Text label of the "Follow on Facebook" dialog
...
NSString *becomefacebookfriendsurl = @"https://www.facebook.com/LAVISIONATL/"; //URL of your Facebook fanpage
NSString *imagedownloadedtitle = @"Imagen guardada en tu galería de fotos.";  //Title label of the "Image saved to your photo gallery" dialog box
NSString *imagenotfound = @"Imagen no encontrada.";  //Title label of the "Image not found" dialog box
